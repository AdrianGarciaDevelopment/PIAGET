   ...
   <form id="form1" runat="server">
        ...
        <div class="divCentrado" style="width:400px;margin-left:auto;margin-right:auto">
            ...
            <table style="width:89%;">
                ...
                <tr>
                    <td class="auto-style8">Fecha Incidente</td>
                    <td class="auto-style9">
                        <asp:Calendar ID="c_fecha" runat="server" Height="151px" Width="130px"></asp:Calendar>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style8">Motivo Incidente</td>
                    <td class="auto-style9">
                ...
                <tr>
                    <td class="auto-style1" colspan="2" style="text-align:center">
                        ...
                        <asp:ImageButton ID="ib_modificar" runat="server" Height="48px" ImageUrl="http://icon-icons.com/icons2/809/PNG/512/edit_icon-icons.com_66118.png" Width="50px" OnClick="ib_modificar_Click" />
                    </td>
                </tr>
            </table>
